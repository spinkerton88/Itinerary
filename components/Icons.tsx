...
export const DiningIcon = ({ className }: { className?: string }) => (
...
export const TransitIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect x="3" y="12" width="18" height="8" rx="2"/><path d="M5 12v-4a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v4"/><path d="M16 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M8 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M3 20h18"/></svg>
);
...
export const CircleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="9"/></svg>
);